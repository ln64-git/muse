...
function SidebarIcon({ src }: { src: string }) {
  return (
    <div className="min-w-[40px] opacity-70 bg-neutral-900 p-2 m-4 rounded-lg transition-all duration-300 transform hover:scale-110 hover:bg-neutral-800 hover:shadow-lg  ">
